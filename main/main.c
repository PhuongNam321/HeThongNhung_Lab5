...
void app_main()
{
  xTimer_1 = xTimerCreate("Timer 1", pdMS_TO_TICKS(1000), pdTRUE, (void*)1, timer_Callback);
  xTimer_2 = xTimerCreate("Timer 2", pdMS_TO_TICKS(1000), pdTRUE, (void*)2, timer_Callback);
  ...
  {
    printf("Can not start timer, exit!!!\r\n");
  }
}